...
traj.f_add_parameter('vVar', np.square(0.01), comment='Variance of velocity measurement in km^2/s^2')
    ...
    cartesian_product(
        {
            ...
            'constantPhaseOffset': np.random.uniform(low=-1.0, high=1.0, size=3)
        }
    )
)
# traj.f_explore(
